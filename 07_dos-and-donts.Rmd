...
`r emo::ji("x")` **Don't track large datasets!** 
...
`r emo::ji("x")` **WARNING FOR MAC USERS: UNDER NO CIRCUMSTANCES SHOULD YOU TRACK .DS_STORE files!**
...
knitr::include_graphics("./figures/2-up-example.png")
```
