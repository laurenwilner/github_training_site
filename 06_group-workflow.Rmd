...
* `r emo::ji("exclamation")` Take care: Now that you are working together, be sure
...
- `r emo::ji("exclamation")` **NEW STEP ALERT**: Fill in the details of the pull
request, explaining what you've added or changed and why. 
- `r emo::ji("exclamation")` **NEW STEP ALERT**: Add your colleague as a 
...
knitr::include_graphics("./figures/no-conflict.PNG")
```
...
```{r, echo=F, out.width='100%'}
knitr::include_graphics("./figures/conflict.PNG")
```
...
Then, create a pull request. `r emo::ji("scared")` Merge conflict! You will not 
